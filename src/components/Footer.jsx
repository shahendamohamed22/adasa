...
function Footer() {
    return (
        <footer className=" w-full bg-[#0a0a0a] text-neutral-300 overflow-hidden border-t border-[#262626]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <form className="space-y-3">
                            ...
                            <button type="submit" className="w-full bg-linear-to-r from-orange-500 to-orange-600 px-5 py-2.5 rounded-full text-white text-sm hover:-translate-y-1 transition-all duration-300">
                                اشترك
                            </button>
                        </form>
                    </div>
